...
COPY "./src/cloudsecnext25" "/app/cloudsecnext25"
...
# Metadata
ARG NAME="cloudsecnext25"
ARG DESCRIPTION="CloudSecNext 🚀"
ARG TIMESTAMP
ARG COMMIT_HASH
ENV SERVICE="${NAME}"
...
LABEL org.opencontainers.image.url="https://github.com/jonzeolla/cloudsecnext25"
LABEL org.opencontainers.image.source="https://github.com/jonzeolla/cloudsecnext25/tree/${COMMIT_HASH}"
